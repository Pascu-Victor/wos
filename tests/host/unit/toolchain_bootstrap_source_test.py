...
def test_wos_build_jobs_helper_has_self_hostable_fallbacks() -> None:
    ...
    require_tokens(
        ...
        [
            ...
            '[ "${WOS_DISTRIBUTED_COMPILER_TRANSPORT:-source}" = staged ]',
...
def test_native_wos_libressl_build_is_serial_by_default() -> None:
    ...
    require_tokens(
        ...
        [
            ...
            "racing the generated .deps/*.Tpo rename",
...
if __name__ == "__main__":
    ...
    test_native_wos_libressl_build_is_serial_by_default()
