...
def test_wos_metadata_batch_abi_preflights_before_effects() -> None:
    ...
    require_order(
        ...
        [
            ...
            "CStringCopyStatus::FAULT",
            "CStringCopyStatus::TOO_LONG",
...
def test_utimensat_reaches_real_vfs_timestamp_updates() -> None:
    ...
    require_tokens(
        ...
        [
            ...
            "usercopy::copy_from_task(*task, a3, kernel_times.data(), sizeof(kernel_times))",
            "ker::vfs::vfs_utimensat(DIRFD, pathname.data(), times, FLAGS)",
        ],
