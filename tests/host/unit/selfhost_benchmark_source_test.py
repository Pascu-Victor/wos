...
def test_selfhost_runner_covers_acceptance_flow() -> None:
    ...
    require_tokens(
        ...
        [
            ...
            "distributed preprocess jobs must be a positive integer",
...
def test_wos_bootstrap_distributes_only_compiler_processes() -> None:
    ...
    require_tokens(
        ...
        [
            ...
            r"compiler_create_shared_file() {",
            r'while ! : > "\$compiler_shared_path"; do',
            r'if [ "\$compiler_shared_attempt" -ge 3 ]; then',
            r"usleep 1000",
            r'compiler_shared_attempt="\$((compiler_shared_attempt + 1))"',
            ...
            r"compiler_claim_job_tag() {",
            r"compiler_claim_attempt < 256",
            r'compiler_claim_candidate="\$\$.\$RANDOM.\$compiler_claim_attempt"',
            r'mkdir "\$compiler_claim_responses/.claim.\$compiler_claim_candidate"',
            r'compiler_job_tag="\$(compiler_claim_job_tag "\$compiler_responses")"',
            r'compiler_response="\$compiler_responses/clang.\$compiler_job_tag"',
            ...
            r'compiler_remote_output="/tmp/wos-distributed-staged.\$compiler_job_tag.output"',
            r'compiler_staged_output="\$compiler_responses/output.\$compiler_job_tag"',
            r'compiler_host_report="\$compiler_responses/host.\$compiler_job_tag"',
            ...
            "PIDs are node-local",
            r'compiler_job_dir="\$compiler_responses/clang-job.\$compiler_job_tag"',
            r'compiler_persist_remote_slots=1',
            r'compiler_preprocess_jobs="\${WOS_DISTRIBUTED_COMPILER_PREPROCESS_JOBS:-\$compiler_local_jobs}"',
            r'compiler_preprocess_slots="\$compiler_state.preprocess-slots"',
            r'compiler_preprocess_slot=""',
            r'compiler_preprocess_start="\$((RANDOM % compiler_preprocess_jobs))"',
            r'compiler_preprocess_slot_release',
...
def test_distributed_compiler_hosts_are_validated_before_launch() -> None:
    ...
    invalid_slot_overrides = [
        ...
        (
            "WOS_SELFHOST_DISTRIBUTED_PREPROCESS_JOBS",
            "invalid",
            "distributed preprocess jobs must be a positive integer",
        ),
        (
