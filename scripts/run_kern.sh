...
qemu-system-x86_64 -M q35 -cpu max -s -S -m 1G \
  ...
  -bios /usr/share/OVMF/x64/OVMF.4m.fd $CHARDEV -d cpu_reset,int,tid,in_asm,guest_errors,page,trace:ps2_keyboard_set_translation -D qemu.%d.log -no-reboot -smp 1
