...
#
# Usage:
#   ./scripts/run_tests.sh                  # build & run all unit tests
#   ./scripts/run_tests.sh build            # build only (unit tests + fuzz targets)
#   ./scripts/run_tests.sh test             # build & run unit tests (ctest)
#   ./scripts/run_tests.sh fuzz [target] [minutes]
#                                           # build & run a fuzz target
#                                           #   target:  wki_wire_fuzz (default)
#                                           #            data_struct_fuzz
#                                           #   minutes: duration (default: 5)
#   ./scripts/run_tests.sh fuzz all [min]   # run every fuzz target sequentially
#   ./scripts/run_tests.sh clean            # remove build directory
#   ./scripts/run_tests.sh list             # list available test & fuzz targets
#   ./scripts/run_tests.sh report           # show summary of last results
#
# Environment:
