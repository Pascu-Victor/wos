...
Examples:
  wos-format
  wos-format modules/kern
  wos-format tools/wosdbg
  wos-format --check modules/kern/src/net/wki
  wos-format --tidy-fix modules/kern/src/net/wki
  wos-format --format-only
