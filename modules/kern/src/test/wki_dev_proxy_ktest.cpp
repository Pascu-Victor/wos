...
KTEST(WkiRemoteVfsLegacyScalar, RejectsUnsafeInexactAndOverflowingPaths) {
    KEXPECT_TRUE(ker::net::wki::wki_remote_vfs_selftest_legacy_scalar_wire_path_admission());
}
