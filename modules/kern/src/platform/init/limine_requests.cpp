...
static __attribute__((used, section(".requests_start_marker"))) volatile uint64_t limine_requests_start_marker[] =
    LIMINE_REQUESTS_START_MARKER;  // NOLINT

static __attribute__((used, section(".requests"))) volatile limine_module_request g_kernel_module_request = {
...
static __attribute__((used, section(".requests"))) volatile limine_executable_cmdline_request g_kernel_cmdline_request = {
    .id = LIMINE_EXECUTABLE_CMDLINE_REQUEST_ID,
    .revision = 0,
    .response = nullptr,
};

static __attribute__((used, section(".requests_end_marker"))) volatile uint64_t limine_requests_end_marker[] =
