...
#if (defined _ISOC99_SOURCE || defined _ISOC11_SOURCE || defined _ISOC23_SOURCE || \
...
#if ((!defined __STRICT_ANSI__ || (defined _XOPEN_SOURCE && (_XOPEN_SOURCE - 0) >= 500)) && !defined _POSIX_SOURCE && \
...
#include <std/features-time64.hpp>
...
/* GNU formerly extended the scanf functions with modified format
   ...
   old extension.  */
#if (defined __USE_GNU && (defined __cplusplus ? (__cplusplus < 201103L && !defined __GXX_EXPERIMENTAL_CXX0X__) \
                                               : (!defined __STDC_VERSION__ || __STDC_VERSION__ < 199901L)))
